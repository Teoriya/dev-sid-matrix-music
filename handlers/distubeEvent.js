  ...
  function generateQueueEmbed(client, guildId, leave) {
    ...
    var embeds = [
      ...
      new MessageEmbed()
        ...
        .setDescription(`> *I support <:MM_youtube:927490212202967051> Youtube, <:MM_spotify:927490278858829855>  Spotify, <:MM_soundcloud:927490252338249728>  Soundcloud and direct MP3 Links!*`)
    ]
    let newQueue = client.distube.getQueue(guild.id);
